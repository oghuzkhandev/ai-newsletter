...
export default async function PricingPage() {
  ...
  return (
    <div className="flex flex-col container mx-auto py-8 px-4 space-y-10">
      {/* Header */}
      <div>
          ...
          {isPro && (
            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
              ...
              <div className="space-y-1">
                <p className="font-medium">Thank you for being a Pro member!</p>
                <p className="text-sm text-muted-foreground">
      ...
      {/* Pricing Section - FULL WIDTH ALTA */}
